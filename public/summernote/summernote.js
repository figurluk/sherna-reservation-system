...
(function (factory) {
    ...
    var Table = function () {
        ...
        this.createTable = function (colCount, rowCount, options) {
            ...
            trHTML = trs.join('');
            var $table = $('<table class="table table-bordered">' + trHTML + '</table>');
            if (options && options.tableClassName) {
                if (typeof pageName !== 'undefined') {
                    if (pageName == "BLOG")
                        $table.addClass(options.tableClassNameBlog);
                }
                else
    ...
    $.summernote = $.extend($.summernote, {
        ...
        options: {
            ...
            tableClassNameBlog: 'table table-blog',
