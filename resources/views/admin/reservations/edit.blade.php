...
@section('content')
    ...
    <form action="{{action('Admin\ReservationsController@update',$reservation->id)}}" class="" method="post">
        {{csrf_field()}}
        <div class="row">
            <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input name="from_date" class="form-control form_datetime" id="from_date"
                                               type="text" value="{{old('from_date',$reservation->start)}}">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="to_date"
                                        ...
                                        <input name="to_date" class="form-control to_datetime" id="to_date"
                                               type="text" value="{{old('to_date',$reservation->end)}}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="visitors_count"
                                       id="visitors_count" value="{{old('visitors_count',$reservation->visitors_count)}}">
                            </div>
                            
                            <div class="form-group">
                                <label for="note"
                                       class="control-label">Note</label>
                                <textarea class="form-control" id="note" name="note" rows="3">{{old('note',$reservation->note)}}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
