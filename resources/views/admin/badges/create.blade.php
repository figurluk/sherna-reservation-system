...
@section('content')
    ...
    <form action="{{action('Admin\BadgesController@store')}}" class="form-horizontal" method="post">
        {!! csrf_field() !!}
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <div class="pull-right">
                            ...
                            <a href="{{action('Admin\BadgesController@index')}}" class="btn btn-danger"><i class="fa fa-times"></i></a>
                        </div>
