                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="location_uid" name="location_uid" value="{{old('location_uid')}}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="reader_uid" class="col-sm-4 control-label">Reader UID</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="reader_uid" name="reader_uid" value="{{old('reader_uid')}}">
                                    </div>
                                </div>
                                <div class="form-group">
